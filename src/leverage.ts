...
export async function ALGOBear1x(userAccount, depositAmount, loanName) {
  try {
    const params = await algodClient.getTransactionParams().do();
    const pools = TestnetPools;

    const flashLoanAmount = depositAmount * 1 * 1e6; // Convert to microAlgos
    ...
    const txns = [...depositTxn, addCollateralTxn, ...syncCollateralTxn, ...borrowTxn, ...unsignedTxns];
...
export async function goETHBear1x(userAccount, depositAmount, loanName) {
  try {
    const params = await algodClient.getTransactionParams().do();
    const pools = TestnetPools;
...
export async function goBTCBear1x(userAccount, depositAmount, loanName) {
  try {
    const params = await algodClient.getTransactionParams().do();
    const pools = TestnetPools;
...
export async function ALGOBull2x(userAccount, depositAmount, loanName) {
  try {
    const params = await algodClient.getTransactionParams().do();
    const pools = TestnetPools;
...
export async function ALGOBull3x(userAccount, depositAmount, loanName) {
    try {
      const params = await algodClient.getTransactionParams().do();
      const pools = TestnetPools;
  
      const flashLoanAmount = depositAmount * 2 * 1e6; // Convert to microAlgos
      const leverageAmount = depositAmount * 1e6 + flashLoanAmount;
      const feeRate = 0.0016; // 16 bp as a decimal
      const flashLoanRepaymentAmount = Math.floor(flashLoanAmount * (1 + feeRate));
  ...
  export async function ALGOBull4x(userAccount, depositAmount, loanName) {
    try {
      const params = await algodClient.getTransactionParams().do();
      const pools = TestnetPools;
  
      const flashLoanAmount = depositAmount * 3 * 1e6; // Convert to microAlgos
      const leverageAmount = depositAmount * 1e6 + flashLoanAmount;
      const feeRate = 0.0016; // 16 bp as a decimal
      const flashLoanRepaymentAmount = Math.floor(flashLoanAmount * (1 + feeRate));
  ...
  export async function goBTCBull2x(userAccount, depositAmount, loanName) {
    try {
      const params = await algodClient.getTransactionParams().do();
      const pools = TestnetPools;
  ...
  export async function goBTCBull3x(userAccount, depositAmount, loanName) {
    try {
      const params = await algodClient.getTransactionParams().do();
      const pools = TestnetPools;
  ...
  export async function goBTCBull4x(userAccount, depositAmount, loanName) {
    try {
      const params = await algodClient.getTransactionParams().do();
      const pools = TestnetPools;
  ...
  export async function goETHBull2x(userAccount, depositAmount, loanName) {
    try {
      const params = await algodClient.getTransactionParams().do();
      const pools = TestnetPools;
  ...
  export async function goETHBull3x(userAccount, depositAmount, loanName) {
    try {
      const params = await algodClient.getTransactionParams().do();
      const pools = TestnetPools;
  ...
  export async function goETHBull4x(userAccount, depositAmount, loanName) {
    try {
      const params = await algodClient.getTransactionParams().do();
      const pools = TestnetPools;
